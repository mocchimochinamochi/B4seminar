 ...
 * ★今回の追加修正:
 * 1. Case 1 のエージェントアイコンの色を、少しオレンジ色を混ぜた黄色に変更 (RGB: 255, 150, 0)
 * ★統合済: 禁則処理と厳密な高さ計算
 */
...
function logUserAction(eventName) {
  ...
  let logLine = "ItoI_name, " + nf(interval, 0, 3) + ", " + evt + ", Scenario:" + currentScenarioID + ", Step:" + scenarioIndex;
...
function logScrollAction(eventType) {
 ...
 let formattedTime = nf((now - scenarioStartTime) / 1000.0, 0, 3);
  ...
  let lineData = "ItoI_name" + ", " + formattedTime + ", " + eventType + ", " + scrollYVal + ", " + percentStr + ", " + visibleMsg + ", " + currentScenarioID + "\n";
